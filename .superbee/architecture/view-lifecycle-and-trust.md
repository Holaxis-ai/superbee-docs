...
[`View` grammar](https://github.com/Holaxis-ai/superbee/blob/77c20318205156d5020a16763e2791845f17826c/packages/core/src/page.ts#L24-L60)
resolves absent or unknown access to `none`, and
[`parsePageRegistration`](https://github.com/Holaxis-ai/superbee/blob/77c20318205156d5020a16763e2791845f17826c/packages/core/src/page.ts#L140-L186)
...
2. Admit bounded UTF-8 `text/html` bytes (at most 512 KiB) and copy them into an immutable launch
   source. The
   [`authorization subject`](https://github.com/Holaxis-ai/superbee/blob/77c20318205156d5020a16763e2791845f17826c/packages/view-runtime/src/authorization.ts#L3-L80)
...
3. Mint a process-local launch with bounded lifetime and registry capacity. The
   [`launch registry`](https://github.com/Holaxis-ai/superbee/blob/77c20318205156d5020a16763e2791845f17826c/packages/view-runtime/src/index.ts#L154-L253)
...
4. Re-read the registered source or transient bundle identity and byte hash before use. The shared
   [`currentness check`](https://github.com/Holaxis-ai/superbee/blob/77c20318205156d5020a16763e2791845f17826c/packages/view-runtime/src/index.ts#L300-L329)
   and
   [`mint paths`](https://github.com/Holaxis-ai/superbee/blob/77c20318205156d5020a16763e2791845f17826c/packages/view-runtime/src/index.ts#L332-L449)
...
6. Mount only the admitted bytes in an opaque-origin iframe with scripts but no same-origin privilege,
   ...
   [`nonce and CSP boundary`](https://github.com/Holaxis-ai/superbee/blob/77c20318205156d5020a16763e2791845f17826c/packages/ui-server/src/pages.ts#L1-L48);
...
7. Around every bounded bridge request, resolve launch currentness and authorization before work and
   ...
   [`bridge fence`](https://github.com/Holaxis-ai/superbee/blob/77c20318205156d5020a16763e2791845f17826c/packages/view-runtime/src/bridge.ts#L325-L400)
...
- `bundle-read` requires exact-byte/access approval, then permits only bounded read, query, render,
  ...
  [`bounded bridge contract`](https://github.com/Holaxis-ai/superbee/blob/77c20318205156d5020a16763e2791845f17826c/packages/view-runtime/src/bridge.ts#L16-L129).
- `bundle-propose` includes reads and may propose one versioned `document.set-field` action. View code
  never writes directly. The
  [`trusted action gate`](https://github.com/Holaxis-ai/superbee/blob/77c20318205156d5020a16763e2791845f17826c/packages/view-runtime/src/index.ts#L729-L795)
...
[`immutable serve and authorization payload`](https://github.com/Holaxis-ai/superbee/blob/77c20318205156d5020a16763e2791845f17826c/packages/ui-server/src/server.ts#L189-L315)
and the UI's
[`source and frame-generation fences`](https://github.com/Holaxis-ai/superbee/blob/77c20318205156d5020a16763e2791845f17826c/packages/ui/src/views/PageFrame.tsx#L247-L335)
...
[`launch and approval flow`](https://github.com/Holaxis-ai/superbee/blob/77c20318205156d5020a16763e2791845f17826c/packages/mcp-app/src/server.ts#L1004-L1152)
keeps bundle-capable transient Views bound to the selected workspace. The fixed App shell constrains
the child with
[`CSP and sandbox policy`](https://github.com/Holaxis-ai/superbee/blob/77c20318205156d5020a16763e2791845f17826c/packages/mcp-app/src/view.ts#L87-L100)
and validates child source, epoch, visibility, and server-owned freshness through the
[`active-child fences`](https://github.com/Holaxis-ai/superbee/blob/77c20318205156d5020a16763e2791845f17826c/packages/mcp-app/src/view.ts#L946-L1026).
