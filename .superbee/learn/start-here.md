...
In Codex or Claude Code with the Superbee Skill installed, start by describing the outcome and your
constraints. Follow [Install and set up Superbee](../get-started/install-and-setup.md) and check
[Host and platform support](../reference/host-and-platform-support.md) before relying on this path.
