...
test("permission-aware sharing owners select every coupled reader journey", async () => {
  ...
  const sourceExpectations = new Map([
    ...
    ["packages/cli/src/command-spec.ts", ["guides/share-and-synchronize-git-bundle"]],
    ...
    ["packages/cli/test/command-spec.test.ts", ["guides/share-and-synchronize-git-bundle"]],
    ...
    ["packages/ui/src/views/Launcher.tsx", ["guides/share-and-synchronize-git-bundle"]],
